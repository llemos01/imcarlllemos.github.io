...
$(document).ready(function() {
    ...
    if(hours < 12) {
        dateStatus = "Morning";
        $(".content-header").css("background-image", "url('../../assets/banner/morning.jpg')");
    } else if(hours < 18) {
        dateStatus = "Afternoon";
        $(".content-header").css("background-image", "url('../../assets/banner/afternoon.jpg')");
    } else {
        dateStatus = "Evening";
        $(".content-header").css("background-image", "url('../../assets/banner/night.jpg')");
    }      
